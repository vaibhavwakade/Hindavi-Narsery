          ...
          <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0 md:pr-6">
              ...
              <p className="text-gray-600 max-w-lg">
                Discover our collection of durable and ergonomic gardening tools
                designed to make your gardening tasks easier and more enjoyable.
              </p>
            </div>
            <img
          ...
          <>
            ...
            <div className="mt-12 bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-medium mb-6">
                Essential Gardening Tool Categories
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white p-5 rounded-lg shadow-sm text-center">
                  <div className="bg-blue-100 w-16 h-16 mx-auto rounded-full flex items-center justify-center mb-4">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M10 18a8 8 0 100-16 8 8 0 000 16zm-5.5-6a.5.5 0 00.5.5h10a.5.5 0 000-1H5a.5.5 0 00-.5.5z"
                        clipRule="evenodd"
                      />
                    </svg>
                  </div>
                ...
                <div className="bg-white p-5 rounded-lg shadow-sm text-center">
                  ...
                  <p className="text-gray-600 text-sm">
                    Trowels, hand forks, weeders, and cultivators for detailed
                    work
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    After each use, remove dirt and debris from your tools. For
                    metal parts, use a wire brush or hose them down. Dry
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Keep cutting tools sharp for efficient use. Use a file,
                    whetstone, or take them to a professional sharpening service
                    annually.
                  </p>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Apply linseed oil to wooden handles to prevent splinters and
                    cracking. Use machine oil on metal parts to prevent rust and
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Store tools in a dry place. Hang larger tools on the wall
                    and keep smaller ones in a bucket filled with sand mixed
