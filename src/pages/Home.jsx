...
import { ArrowLeft, ArrowRight, Leaf, ShoppingBag, Truck, MapPin } from 'lucide-react';
  ...
  const heroSlides = [
    {
      ...
      description: "Discover our curated selection of air-purifying plants that bring life to every corner of your home",
    ...
    },
    {
      ...
      description: "Create a stunning landscape with our selection of outdoor plants, trees and flowering shrubs",
    ...
    },
    {
      ...
      description: "Complement your greenery with our range of stylish pots and planters for every décor style",
      cta: "View Planters",
      link: "/pots"
    }
  ];
    ...
    <div className="space-y-12 pb-12">
      ...
      <section className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">Explore our wide selection of plants and accessories for your home and garden</p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 md:p-6 z-20">
              <h3 className="text-white text-base sm:text-lg md:text-2xl font-bold mb-1 md:mb-2">Indoor Plants</h3>
              <span className="inline-flex items-center text-white text-sm md:text-base hover:text-green-300 transition-colors">
                Shop Now 
                <svg className="w-3 h-3 sm:w-4 sm:h-4 ml-1 md:ml-2 group-hover:translate-x-1 transition-transform" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </span>
            </div>
            <Link to="/indoor-plants" className="absolute inset-0 z-30" aria-label="Shop Indoor Plants"></Link>
          </motion.div>
          ...
          >
            ...
            />
            <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 md:p-6 z-20">
              <h3 className="text-white text-base sm:text-lg md:text-2xl font-bold mb-1 md:mb-2">Outdoor Plants</h3>
              <span className="inline-flex items-center text-white text-sm md:text-base hover:text-green-300 transition-colors">
                Shop Now 
                <svg className="w-3 h-3 sm:w-4 sm:h-4 ml-1 md:ml-2 group-hover:translate-x-1 transition-transform" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <Link to="/outdoor-plants" className="absolute inset-0 z-30" aria-label="Shop Outdoor Plants"></Link>
          </motion.div>
          ...
          >
            ...
            />
            <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 md:p-6 z-20">
              <h3 className="text-white text-base sm:text-lg md:text-2xl font-bold mb-1 md:mb-2">Planters & Pots</h3>
              <span className="inline-flex items-center text-white text-sm md:text-base hover:text-green-300 transition-colors">
                Shop Now 
                <svg className="w-3 h-3 sm:w-4 sm:h-4 ml-1 md:ml-2 group-hover:translate-x-1 transition-transform" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <Link to="/products?type=pots" className="absolute inset-0 z-30" aria-label="Shop Planters & Pots"></Link>
          </motion.div>
          ...
          >
            ...
            />
            <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 md:p-6 z-20">
              <h3 className="text-white text-base sm:text-lg md:text-2xl font-bold mb-1 md:mb-2">Gardening Tools</h3>
              <span className="inline-flex items-center text-white text-sm md:text-base hover:text-green-300 transition-colors">
                Shop Now 
                <svg className="w-3 h-3 sm:w-4 sm:h-4 ml-1 md:ml-2 group-hover:translate-x-1 transition-transform" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <Link to="/tools" className="absolute inset-0 z-30" aria-label="Shop Gardening Tools"></Link>
          </motion.div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-8">
        ...
        >
          <div className="absolute top-0 left-0 w-full h-full">
            <svg viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg" className="opacity-10">
              <path d="M361.5,205.5Q323,411,154.5,302.5Q-14,194,153.5,122.5Q321,51,361.5,205.5Z" fill="#ffffff"></path>
            </svg>
          </div>
          <div className="relative z-10 py-16 px-8 md:px-16 text-center md:text-left md:flex md:items-center md:justify-between">
            <div className="mb-8 md:mb-0 md:mr-8">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Start Your Plant Journey?</h2>
              <p className="text-green-50 md:text-lg max-w-xl">
                Join thousands of happy plant parents and transform your space today with our healthy, beautiful plants.
              </p>
            </div>
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              <Link to="/products" className="bg-white text-green-700 hover:text-green-800 hover:bg-gray-100 transition-colors px-8 py-3 rounded-lg font-medium shadow-lg">
                Shop Now
              </Link>
              <Link to="/about" className="border border-white text-white hover:bg-white/10 transition-colors px-8 py-3 rounded-lg font-medium">
                Learn More
              </Link>
            </div>
          </div>
