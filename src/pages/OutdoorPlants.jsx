  ...
  useEffect(() => {
    const fetchOutdoorPlantCategory = async () => {
      try {
        ...
        const outdoorPlantsCategory = categories.find(
          (category) =>
        ...
        if (outdoorPlantsCategory) {
          ...
          setError(
            "Could not load outdoor plants category. Displaying all available plants.",
          );
        }
      } catch (error) {
          ...
          <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0 md:pr-6">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">
                {plantType
                  ? `Discover Our ${plantType.charAt(0).toUpperCase() + plantType.slice(1)} Plants`
            ...
            <img
              ...
              alt={
                plantType
                  ? `${plantType.charAt(0).toUpperCase() + plantType.slice(1)} Plants Collection`
          ...
          <>
            ...
            <div className="mt-12 bg-gray-50 p-6 rounded-lg">
              <h3 className="text-xl font-medium mb-4">
                {plantType
                  ? `${plantType.charAt(0).toUpperCase() + plantType.slice(1)} Plant Care Tips`
