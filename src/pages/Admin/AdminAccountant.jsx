...
function AdminAccountantPage() {
    ...
    const fetchSummary = async () => {
        ...
        try {
            ...
            const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/accountant/summary`, {
    ...
    const exportPDF = () => {
        ...
        const docDefinition = {
            content: [
                ...
                { text: `Generated: ${format(new Date(), 'yyyy-MM-dd HH:mm')}`, margin: [0, 10] },
        ...
        pdfMake.createPdf(docDefinition).download(`AccountantAnalysis_${start}_to_${end}.pdf`);
        ...
        <div className="min-h-screen bg-green-50 px-4 py-6 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto bg-white shadow-md rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    {['Orders Summary', 'Financial Summary', 'Attendance Summary'].map((title, idx) => (
                        <div key={idx} className="bg-white border border-green-200 shadow-sm p-4 rounded">
                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full bg-white border border-green-200 rounded-lg">
                        <thead className="bg-green-100">
                            <tr>
                                {['Name', 'Email', 'Salary', 'Present', 'Absent', 'Leave'].map(h => (
                                    <th key={h} className="px-4 py-2 border text-green-800">{h}</th>
                                ))}
                            </tr>
                        </thead>
                        <tbody>
