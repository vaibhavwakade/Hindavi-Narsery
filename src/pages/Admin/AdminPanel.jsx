  ...
  useEffect(() => {
    const checkAdmin = async () => {
      try {
        ...
        toast.error(
          error.response?.data?.message || "Failed to load admin panel",
        );
        navigate("/login");
      } finally {
        setLoading(false);
    ...
    <div className="flex min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
        ...
        <nav className="px-4 py-6">
          <div className="space-y-2">
            ...
            <div className="mb-6">
              ...
              >
                <div
                  className={`flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center mr-3 transition-all duration-200 ${
                    !activeTab
                      ? "bg-white/20"
                ...
                >
                  <BarChart3
                    className={`h-5 w-5 ${!activeTab ? "text-white" : "text-green-600"}`}
                  />
                </div>
                <div className="text-left">
                  <div className="font-semibold">Dashboard</div>
                  <div
                    className={`text-xs ${!activeTab ? "text-green-100" : "text-green-600"}`}
                  >
                    Analytics & Stats
                  </div>
                </div>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2">
                <button
                  onClick={() =>
                    handleNavigate("/admin/add-category", "category")
                  }
                  className={`w-full flex items-center px-4 py-3 rounded-xl transition-all duration-200 group ${
                    activeTab === "category"
                      ? "bg-gradient-to-r from-green-500 to-emerald-600 text-white shadow-lg"
                ...
                >
                  ...
                  >
                    <Leaf
                      className={`h-5 w-5 ${activeTab === "category" ? "text-white" : "text-yellow-600"}`}
                    />
                  </div>
                  <div className="text-left">
                    <div className="font-semibold">Add Category</div>
                    <div
                      className={`text-xs ${activeTab === "category" ? "text-green-100" : "text-green-600"}`}
                    >
                      Category management
                    </div>
                  </div>
                ...
                <button
                  onClick={() =>
                    handleNavigate("/admin/create-product", "products")
                  }
                  className={`w-full flex items-center px-4 py-3 rounded-xl transition-all duration-200 group ${
                    activeTab === "products"
                      ? "bg-gradient-to-r from-green-500 to-emerald-600 text-white shadow-lg"
                ...
                >
                  ...
                  >
                    <Package
                      className={`h-5 w-5 ${activeTab === "products" ? "text-white" : "text-green-600"}`}
                    />
                  </div>
                  <div className="text-left">
                    <div className="font-semibold">Add Products</div>
                    <div
                      className={`text-xs ${activeTab === "products" ? "text-green-100" : "text-green-600"}`}
                    >
                      Plants & accessories
                    </div>
                  </div>
                ...
                <button
                  onClick={() =>
                    handleNavigate("/admin/manage-products", "manage-products")
                  }
                  className={`w-full flex items-center px-4 py-3 rounded-xl transition-all duration-200 group ${
                ...
                >
                  ...
                  >
                    <Settings
                      className={`h-5 w-5 ${activeTab === "manage-products" ? "text-white" : "text-blue-600"}`}
                    />
                  </div>
                  <div className="text-left">
                    <div className="font-semibold">Manage Products</div>
                    <div
                      className={`text-xs ${activeTab === "manage-products" ? "text-green-100" : "text-green-600"}`}
                    >
                ...
                >
                  ...
                  >
                    <Users
                      className={`h-5 w-5 ${activeTab === "users" ? "text-white" : "text-purple-600"}`}
                    />
                  </div>
                  <div className="text-left">
                    <div className="font-semibold">Users</div>
                    <div
                      className={`text-xs ${activeTab === "users" ? "text-green-100" : "text-green-600"}`}
                    >
                      Customer accounts
                    </div>
                  </div>
                ...
                >
                  ...
                  >
                    <ShoppingBag
                      className={`h-5 w-5 ${activeTab === "orders" ? "text-white" : "text-blue-600"}`}
                    />
                  </div>
                  <div className="text-left">
                    <div className="font-semibold">Orders</div>
                    <div
                      className={`text-xs ${activeTab === "orders" ? "text-green-100" : "text-green-600"}`}
                    >
                      Order management
                    </div>
                  </div>
                ...
                >
                  ...
                  >
                    <Stars
                      className={`h-5 w-5 ${activeTab === "reviews" ? "text-white" : "text-blue-600"}`}
                    />
                  </div>
                  <div className="text-left">
                    <div className="font-semibold">Reviews</div>
                    <div
                      className={`text-xs ${activeTab === "reviews" ? "text-green-100" : "text-green-600"}`}
                    >
                      Manage Reviews
                    </div>
                  </div>
      ...
      <main className="flex-1 p-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Manage your nursery operations efficiently
              </p>
            </div>
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 min-h-[600px]">
          <div className="p-8">
            {!activeTab ? <AdminDashboard /> : <Outlet />}
          </div>
        </div>
      </main>
    </div>
